...
buckets = {
    ...
    "pH_regulation": torch.arange(0, 0.4, 0.0015),  # in ml
    "temperature": torch.arange(30, 80, 1),  # in degrees C
    "NiSO4": torch.arange(0, 0.8, 0.004),  # 1/200 * 0.8 in mol/L
    "Na2MoO4": torch.arange(0, 0.8, 0.004),  # 1/200 * 0.8 in mol/L
    "H2SO4": torch.arange(0, 3, 0.015),  # 1/200 * 3 in mol/L
    # TODO: check if this is correct
    "liquid1": torch.arange(0, 1.0, 0.005),  # 1/200 * 1 in mol/L
    "liquid2": torch.arange(0, 1.0, 0.005),  # 1/200 * 1 in mol/L
}
...
if __name__ == "__main__":
    ...
    ##########################################################
    # Tests if inidividual functions work
    ##########################################################
